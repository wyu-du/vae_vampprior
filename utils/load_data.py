...
def load_dataset(args, **kwargs):
    ...
    elif args.dataset_name == 'rcv':
        train_loader, val_loader, test_loader, args = load_rcv(args, **kwargs)
    else:
...
# ======================================================================================================================
def load_rcv(args, TRAIN = 635532, VAL = 158882, TEST = 10000, **kwargs):
    # set args
    args.input_size = [1, 10000]
    args.input_type = 'binary'
    args.dynamic_binarization = False

    # start processing
    data = []
    with open('datasets/rcv1-v2/corpus.txt', 'r') as f:
        lines = f.read().split('\n')
        for line in lines:
            if len(line) == 0: continue
